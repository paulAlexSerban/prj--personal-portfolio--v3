    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                dropdowns: cn('flex h-(--cell-size) w-full items-center justify-center gap-1.5 text-base font-medium', defaultClassNames.dropdowns),
                dropdown_root: cn(
                ...
                caption_label: cn(
                    ...
                    captionLayout === 'label' ? 'text-base' : '[&>svg]:text-muted-foreground flex h-8 items-center gap-1 rounded-md pl-2 pr-1 text-base [&>svg]:size-3.5',
