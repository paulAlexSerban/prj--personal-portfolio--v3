...
export function QuizFlashcardSummary({
    previewCount,
    totalQuestionCount,
    correctCount,
    quizAppHref,
    onRestart,
}: QuizFlashcardSummaryProps) {
    ...
    return (
        <div className="text-center">
            ...
            <div
                className="my-8 grid grid-cols-2 divide-x-2 divide-ink border-y-2 border-ink"
            ...
            <p className="mx-auto max-w-xl text-base leading-relaxed text-charcoal">
                This was a sample of {previewCount} question {plural(previewCount, 'type')} from this post&apos;s full
                quiz - {totalQuestionCount} {plural(totalQuestionCount, 'question')} total
                {remaining > 0 ? `, with ${remaining} more in the app` : ''}. This flashcard preview is a demo of what
                you&apos;ll find in the full spaced-repetition quiz app.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
                <a
                    ...
                    title="Open this post's full quiz in a new tab"
                >
