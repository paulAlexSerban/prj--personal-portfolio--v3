...
export function stampClasses(variant: StampVariant = "solid", size: StampSize = "md", extra = "") {
  ...
  const sizeCls =
    size === "sm" ? "text-xs px-3 py-1.5" : size === "lg" ? "text-base px-6 py-3" : "text-sm";
...
export const Stamp = forwardRef<HTMLButtonElement, Props>(function Stamp(
  { variant = "solid", size = "md", className = "", children, type = "button", ...rest },
  ref,
) {
  return (
